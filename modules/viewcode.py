...
def create_image_from_code(code, command_name, font_path="modules/cache/font/NotoSans-Bold.ttf"):
    ...
    max_width = max(temp_draw.textlength(line, font=temp_font) for line in code_lines) + 200
    img_width = max(3200, max_width)
    ...
    command_font = ImageFont.truetype(fontlenh, 28)
    ...
    draw.text((tab_x + python_logo_width + tab_padding * 2, tab_y + 10), command_text, font=command_font, fill=(255, 255, 255))
