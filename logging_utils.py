class Logging:
    ...
    def warning(self, text: str) -> None:
        text = str(text)
        print(f"{self.orange or self.yellow} {self.log_text_color}WARNING {self.reset} {self.textcolor}{text}")

    def log(self, text: str) -> None:
        text = str(text)
        print(f"{self.green} {self.log_text_color}LOGGING {self.reset} {self.textcolor}{text}")

    def info(self, text: str) -> None:
        text = str(text)
        print(f"{self.blue} {self.log_text_color}INFO {self.reset} {self.textcolor}\n{text}")