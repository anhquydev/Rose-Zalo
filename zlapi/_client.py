...
class ZaloAPI(object):
    ...
    def listen(self, delay=0, thread=False, type="websocket", run_forever=False, reconnect=5):
    ...
    def onLoggingIn(self, phone=None):
        ...
        """
        logger.debug("\033[1;36m[STATUS] Logging > {}...".format(phone))
    ...
    def onLoggedIn(self, phone=None):
        ...
        Args:
            phone: The phone number of the client
        """
        logger.login("\033[1;32mĐang Chạy Bot By Anh Quý Trên Số : {}.".format(phone))
    
    def onListening(self):
        """Called when the client is listening."""
        logger.debug("\033[1;35mft. Anhquyiue!")
